...
export const SPORTS: Record<string, SportConfig> = {
  hockey: {
    ...
    portal: { heroImage:'/sports/hockey.jpg', headline:'HOCKEY', description:'Fixtures, training updates, programmes and department notices — all in one place.' },
  ...
  rugby: {
    ...
    portal: { heroImage:'/sports/rugby.jpg', headline:'RUGBY', description:'Fixtures, team updates, programmes and department notices — all in one place.' },
    terminology: { group:'Age Group', unit:'Team', fixture:'Fixture', result:'Result', athlete:'Player', score:'Score', session:'Training' },
    features: { teams:true, fixtures:true, results:true, programs:true, attendance:true, testing:true, playerSpotlight:true, pbTracking:false, eventEntries:false, crews:false, coachNotes:true },
  },
  cricket: {
    label: 'Cricket', structure: 'team', season: 'summer', color: '#fbbf24', icon: '🏏',
    portal: { heroImage:'/sports/cricket.jpg', headline:'CRICKET', description:'Fixtures, match updates, programmes and department notices — all in one place.' },
  ...
  swimming: {
    ...
    portal: { heroImage:'/sports/swimming.jpg', headline:'SWIMMING', description:'Galas, squad updates, programmes and department notices — all in one place.' },
  ...
  rowing: {
    ...
    portal: { heroImage:'/sports/rowing.jpg', headline:'ROWING', description:'Regattas, crew updates, programmes and department notices — all in one place.' },
  ...
  waterpolo: {
    ...
    portal: { heroImage:'/sports/waterpolo.jpg', headline:'WATER POLO', description:'Fixtures, team updates, programmes and department notices — all in one place.' },
    terminology: { group:'Age Group', unit:'Team', fixture:'Fixture', result:'Result', athlete:'Player', score:'Score', session:'Training' },
    features: { teams:true, fixtures:true, results:true, programs:true, attendance:true, testing:false, playerSpotlight:true, pbTracking:false, eventEntries:false, crews:false, coachNotes:true },
  },
  football: {
    label: 'Football', structure: 'team', season: 'short', color: '#a3e635', icon: '⚽',
    portal: { heroImage:'/sports/football.jpg', headline:'FOOTBALL', description:'Fixtures, match updates, programmes and department notices — all in one place.' },
