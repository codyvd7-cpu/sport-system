...
export const SPORTS: Record<string, SportConfig> = {
  hockey: {
    ...
    portal: { heroImage:'/bg-hero-1.jpg', headline:'HOCKEY', description:'Fixtures, training updates, programmes and department notices — all in one place.' },
  ...
  rugby: {
    ...
    portal: { heroImage:'/bg-hero-2.jpg', headline:'RUGBY', description:'Fixtures, team updates, programmes and department notices — all in one place.' },
    terminology: { group:'Age Group', unit:'Team', fixture:'Fixture', result:'Result', athlete:'Player', score:'Score', session:'Training' },
    features: { teams:true, fixtures:true, results:true, programs:true, attendance:true, testing:true, playerSpotlight:true, pbTracking:false, eventEntries:false, crews:false, coachNotes:true },
  },
  cricket: {
    label: 'Cricket', structure: 'team', season: 'summer', color: '#fbbf24', icon: '🏏',
    portal: { heroImage:'/bg-hero-3.jpg', headline:'CRICKET', description:'Fixtures, match updates, programmes and department notices — all in one place.' },
  ...
  swimming: {
    ...
    portal: { heroImage:'/bg-hero-4.jpg', headline:'SWIMMING', description:'Galas, squad updates, programmes and department notices — all in one place.' },
  ...
  rowing: {
    ...
    portal: { heroImage:'/bg-hero-3.jpg', headline:'ROWING', description:'Regattas, crew updates, programmes and department notices — all in one place.' },
  ...
  waterpolo: {
    ...
    portal: { heroImage:'/bg-hero-4.jpg', headline:'WATER POLO', description:'Fixtures, team updates, programmes and department notices — all in one place.' },
    terminology: { group:'Age Group', unit:'Team', fixture:'Fixture', result:'Result', athlete:'Player', score:'Score', session:'Training' },
    features: { teams:true, fixtures:true, results:true, programs:true, attendance:true, testing:false, playerSpotlight:true, pbTracking:false, eventEntries:false, crews:false, coachNotes:true },
  },
  football: {
    label: 'Football', structure: 'team', season: 'short', color: '#a3e635', icon: '⚽',
    portal: { heroImage:'/bg-hero-2.jpg', headline:'FOOTBALL', description:'Fixtures, match updates, programmes and department notices — all in one place.' },
