...
const BENCH: Record<string,[number,number,number,number]> = {
  ...
  pushup_reps:[22,18,14,10], triple_broad_jump:[680,600,530,460],
...
export default function ClassExport({ params }: PageProps) {
  ...
  React.useEffect(()=>{
    ...
    fetch('/api/hp/ai-report',{
      ...
      .then(d=>{ setAiReport(d.report||d.error||'Report unavailable.'); setAiLoading(false); })
      .catch(()=>{ setAiReport('AI report could not be generated.'); setAiLoading(false); });
    ...
    <>
      ...
      <div className="ai-box">
        <div className="ai-header">
          ...
          <div className="ai-badge">Powered by Claude AI · Kinetiq Sport</div>
        </div>
        {aiSections.length>0?(
