  ...
  return (
    <main style={{ minHeight: '100vh', background: '#060916', color: 'white', fontFamily: 'Inter, system-ui, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      ...
      <div style={{ width: '100%', maxWidth: 460 }}>
        <Link href="/dashboard" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: 18 }}>
          ← Back to Dashboard
        </Link>
