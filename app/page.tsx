...
const DEPARTMENTS = [
  {
    id: 'hockey',
    name: 'Hockey',
    subtitle: 'Fixtures, results, weekly updates and team news for all squads',
    href: '/portal',
    icon: '🏑',
    color: 'sky',
    stats: ['Fixtures & results', 'Week updates', 'Player portal', 'All squads'],
    available: true,
  },
  {
    id: 'hp',
    name: 'HP Classes',
    subtitle: 'Dedicated gym training for Grade 8 & 9 — attendance, testing and performance tracking',
    href: '/hp-login',
    icon: '⚡',
    color: 'emerald',
    stats: ['Grade 8 & 9', 'Fitness testing', 'Training groups', 'Trends'],
    available: true,
  },
  {
    id: 'rugby',
